...
export class ChutesAndLadders implements IChutesAndLadders {
  ...
  addAvatarSvgToDisplay = (name: string) => {
    switch (name) {
      ...
      case AvatarTotemsChutesAndLadders.totemsList[1].name:
        return AvatarTotemsChutesAndLadders.totemsList[1].image;
      case AvatarTotemsChutesAndLadders.totemsList[2].name:
        return AvatarTotemsChutesAndLadders.totemsList[2].image;
      case AvatarTotemsChutesAndLadders.totemsList[3].name:
        return AvatarTotemsChutesAndLadders.totemsList[3].image;
      default:

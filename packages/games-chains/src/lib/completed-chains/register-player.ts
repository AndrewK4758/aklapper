...
import registerPlayerStart from '../commands/action-register-player/register-player-start.js';

export const registerChain = ChainBuilder.build(
  [registerPlayerStart, createPlayerID, registerOnGameInstance, filterSelectedAvatar, playerCreated],
  false,
);

...
export const IntroText = () => (
  <Typography variant='body1' id={ID} data-testid={ID} textAlign={'justify'}>
    A am a full-stack web developer with 3 years experience developing & deploying web based applications & projects. I
    specialize in <span className='bold-text'>Monorepo Architectures</span>,{' '}
    ...
    <span className='bold-text'>Go</span>, <span className='bold-text'>PostgreSQL</span>,{' '}
    <span className='bold-text'>MongoDB</span>, <span className='bold-text'>Nx</span>,{' '}
    <span className='bold-text'>API Design</span>, <span className='bold-text'>Gen-AI Agents & Prompts</span>. I utilize{' '}
    <span className='bold-text'>Docker</span>, <span className='bold-text'>Github Actions</span>, &{' '}
    <span className='bold-text'>GCP AppEngine & Cloud Run</span> for my{' '}
    <span className='bold-text'>CI/CD Pipeline</span>. I have a work ethic & focused determination which thrives in
    fast-paced environments. Increasing efficiency & delivering robust, end-to-end solutions & applying best practices
    with new technologies are what I enjoy the most. I enjoy collaborative environments & tackling complex challenges,
    delivering high-quality solutions, & adding value to any team.
    <br />
    <br />

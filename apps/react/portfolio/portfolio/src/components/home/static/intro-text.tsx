...
export const IntroText = () => {
  ...
  return (
    ...
    >
      ...
      approach to problem-solving. I'm excited to bring my passion & skills to a team where I can contribute to
      meaningful projects & continue to grow as a developer.
    </Typography>
  );
};
